    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'mobile_phone',
                    models.CharField(blank=True, help_text='شماره موبایل کاربر', max_length=15, null=True, unique=True),
                ),
                (
                    'account_type',
                    models.CharField(
                        choices=[('normal_user', 'Normal User'), ('premium_user', 'Premium User')],
                        default='normal_user',
                        help_text='نوع اکانت',
                        max_length=15,
                    ),
                ...
                (
                    'volume_choice',
                    models.CharField(choices=[('mg', 'Mg'), ('gb', 'Gb'), ('tra', 'Tra')], default='gb', max_length=7),
                ),
                (
                    'volume',
                ...
                (
                    ...
                    models.FloatField(
                        blank=True,
                        default=0,
                        help_text='حجم مصرفی میباشد که بر اساس مگابایت هست',
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
                ...
                (
                    'number_of_login',
                    models.PositiveIntegerField(
                        db_default=0, default=0, editable=False, help_text='تعداد لاگین های کاربر'
                    ),
                ),
                (
                    'is_connected_user',
                    models.BooleanField(
                        default=False, help_text='این فیلد مشخص میکنه که کاربر ایا به کانفیگش متصل شده هست یا خیر'
                    ),
                ),
                (
                    'number_of_max_device',
                    models.PositiveIntegerField(default=1, help_text='هر اکانت چند تا یوزر میتواند به ان متصل شود'),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[('direct', 'ستقیم'), ('tunnel', 'تانل'), ('tunnel_direct', 'تانل دایرکت')],
