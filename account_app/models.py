...
from account_app.enums import AccountType, AccountStatus, VolumeChoices, UserTypeChoices
...
class User(AbstractUser):
    ...
    user_type = models.CharField(choices=UserTypeChoices, null=True, blank=True, max_length=14,
...
class ContentDevice(models.Model):
